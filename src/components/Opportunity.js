...
export default function Opportunity() {
    return (
        <div className="bg-white py-24 sm:py-32" style={{background: "#f6fcff"}}>
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-base font-semibold leading-7 text-indigo-600">Benefits with us</h2>
                    <p className="mt-2 text-6xl font-bold tracking-tight text-gray-900 sm:text-6xl">Opportunity GDSC provides students with</p>
                    <p className="mt-6 text-lg leading-8 text-gray-600">iat blandit at. In mi viverra elit nunc.</p>
                </div>
